<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="send-separation-ean-list-modal" 
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="send-separation-ean-list-form"></form>
            <div class="modal-body">

            </div>
            
            <div class="modal-footer d-block text-center">
                <input form="send-separation-ean-list-form" type="submit" class="btn btn-success btn-lg" value="<?= _('Enviar') ?>">
